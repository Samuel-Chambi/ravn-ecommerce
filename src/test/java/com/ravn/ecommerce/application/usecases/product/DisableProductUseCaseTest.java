...
class DisableProductUseCaseTest {
    ...
    @InjectMocks
    private DisableProductUseCase useCase;
    ...
    private Product buildEnabledProduct() {
    ...
    @Test
    @DisplayName("Should disable product successfully when user is MANAGER")
    void shouldDisableProductSuccessfully() {
        User manager = buildUser(UserRole.MANAGER);
        Product product = buildEnabledProduct();
